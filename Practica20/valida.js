...
function validaForm(){
	...
	if(/\w{1,20}/.test(document.registro.nombre.value)){
		document.getElementById("error_nombre").style.visibility="hidden";
	}else{
		document.getElementById("error_nombre").style.visibility="visible";
		bandera++;
	...
	//Valida el correo
	if(/\w{1,20}/.test(document.registro.descripcion.value)){
		document.getElementById("error_descripcion").style.visibility="hidden";
	}else{
		document.getElementById("error_descripcion").style.visibility="visible";
		bandera++;
	}

	//Valida la contraseña
	if(/\w{1,20}/.test(document.registro.cantidad.value)){
		document.getElementById("error_cantidad").style.visibility="hidden";
	}else{
		document.getElementById("error_cantidad").style.visibility="visible";
		bandera++;
	}
